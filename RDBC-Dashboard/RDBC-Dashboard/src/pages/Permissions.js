...
const PermissionManagement = () => {
  ...
  const handleAddRole = () => {
    ...
    const newRole = {
      id: roles.length + 1, // Or generate a unique ID dynamically
      name: newRoleName,
      permissions: [],
    };
    addRole(newRole); // Adds the new role using the context function
    setNewRoleName("");
  };
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div className="mt-5">
        ...
        />
        <button onClick={handleAddRole} className="bg-blue-500 text-white px-4 py-2 mb-4">
          Add Role
        </button>
      </div>
